...
import { useTheme } from '@mui/material/styles'; // 1. Importar useTheme

export function SitemarkIcon() {
    const theme = useTheme(); // 2. Acessar o objeto de tema
    ...
    return (
        <SvgIcon sx={{ height: 21, width: 100, mr: 2 }}>
            ...
            >
                {/* 3. Substituir cores fixas por cores do tema */}
                <path
...
// Ícones de marcas - mantêm cores originais
...
export const CicarusFullLogo = () => {
    ...
    // 4. Aplicar filtro de inversão de cor à imagem do logo se o tema for escuro
    const logoStyle = {
        width: '200px',
        height: 'auto',
