        ...
        <StyledToolbar variant="dense" disableGutters>
          ...
          >
            ...
            <Box sx={{ display: { xs: "none", md: "flex" } }}>
              ...
              <Button
                component={Link}
               to="/user-investments" variant="text" color="info" size="small">Investimentos</Button>
                            <Button component={Link} to="/loan"
                variant="text"
                color="info"
                size="small"
              >
          ...
          <Box sx={{ display: { xs: "flex", md: "none" }, gap: 1 }}>
            ...
            <Drawer anchor="top" open={open} onClose={toggleDrawer(false)}>
              <Box sx={{ p: 2, backgroundColor: "background.default" }}>
                ...
                <MenuItem
                  onClick={() => {
                   navigate('/investments'); toggleDrawer(false)(); }}>Investimentos</MenuItem>
                                <MenuItem onClick={() => { navigate('/loan'); toggleDrawer(false)(); }}>Empréstimos</MenuItem>
                                <MenuItem onClick={() => { navigate("/exchange");
                    toggleDrawer(false)();
                  }}
                >
                  Câmbio
                </MenuItem><MenuItem onClick={() => { navigate('/agencias'); toggleDrawer(false)(); }}>Agências</MenuItem>
